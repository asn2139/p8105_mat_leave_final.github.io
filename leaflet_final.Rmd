---
title: "Spacial Distribution of Maternity Leave"
output: 
  html_document:
    toc: TRUE
    toc_float: TRUE
...
We created a series of leaflet maps to understand how type and length of maternity leave vary by NYC zip code and borough among 2016 Work and Family Leave Survey participants. We also mapped key sociodemographic characteristics that we believed could influence maternity leave length.
...
ed_lab= c("No high school degree", "^", "^", "High school degree / GED", "Some college or technical school", "Four year college or higher")
...
This map shows that survey respondents from Upper Manhattan, specifically the neighborhoods of Inwood, Washington Heights, and Central Bronx, reported taking the most weeks of unpaid leave. 
...
Respondents from Long Island, middle and lower Manhattan, and the western sides of Brooklyn and Queens were predominantly White. Respondents from neighborhoods in eastern Brooklyn and Queens were majority Black / African American. In upper Manhattan, the majority of respondents reported Hispanic race or ethnicity. 
...
Across the NYC zip codes, the majority of respondents had at least a high school diploma or GED. Having a four year college degree or higher was more common in lower and middle Manhattan and the western side of Brooklyn and Queens. 
...
Overall, these maps suggest that type of maternity leave, length of unpaid leave, and sociodemographic characteristics are clustered geographically in New York City. We performed a spacial analysis and regression to formerly test these associations, the results of which can be found on our [regression page](add regression HTML).
